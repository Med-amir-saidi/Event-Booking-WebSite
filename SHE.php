...
if (isset($_POST['logout'])) {
    ...
    header('Location: http://localhost/php/She/index.php');
    exit;
}
?>
    ...
    <video width="500px" controls autoplay muted loop style="width: 90%; height:90%;">
        <source src="video/F1.mp4" type="video/mp4">
             ...
             <div class="event_carte">
                ...
                <div style="width: 320px; height: 320px; overflow: hidden;">
    <video width="500px" controls autoplay muted loop style="width: 90%; height:90%;">
        w<source src="video/zebra.mp4" type="video/mp4">
    </video>
</div>
                </div>
                <div class="event-info">
                ...
                <div style="width: 320px; height: 320px; overflow: hidden;">
    <video width="500px" controls autoplay muted loop style="width: 90%; height:90%;">
        w<source src="video/rosa.mp4" type="video/mp4">
    </video>
</div>
                </div>
                <div class="event-info">
...
<section class="about" id="about">
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <h3>contact info</h3>
                <a> <i class="fas fa-phone"></i> +216 52 636 915 </a>
                <a> <i class="fas fa-phone"></i> +216 29 966 046 </a>
                <a> <i class="fas fa-envelope"></i> amirsaidi2705@gmail.com </a>
                <a> <i class="fas fa-envelope"></i> skyhightevents@gmail.com </a>
                <a> <i class="fas fa-map-marker-alt"></i> ben arous/ Mourouj, Tunisia  </a>
            </div>
    
            <div class="box">
                <h3>follow us</h3>
                <a href="https://www.facebook.com/mouhamed.amir.1293"> <i class="fab fa-facebook-f"></i> facebook </a>
